document.addEventListener("DOMContentLoaded", function () {
    ...
    const callback = (responseStatus, responseData) => {
        ...
        if (responseStatus == 200) {
            const profilePicture1 = document.getElementById('profilePic').querySelectorAll('img');
            profilePicture1[0].src = responseData[0].profile;
        } else {
    ...
    fetchMethod(currentUrl + "/api/users/verify", callback, "GET", null, token);
});